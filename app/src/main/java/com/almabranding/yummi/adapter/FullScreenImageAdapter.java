...
public class FullScreenImageAdapter extends PagerAdapter {
    ...
    private ArrayList<ImageModel> _imagePaths;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        ImageModel im = _imagePaths.get(position);

        Picasso.with(_activity).load(im.getFirstImagePath()).resize(size.x + 100,size.y).centerCrop().into(imgDisplay);
