 ...
 */
public class HeightRangeSeek<T extends Number> extends ImageView {
    /**
     * Default color of a {@link HeightRangeSeek}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    ...
    public HeightRangeSeek(Context context) {
        super(context);
        init(context, null);
    }

    public HeightRangeSeek(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HeightRangeSeek(Context context, AttributeSet attrs, int defStyle) {
...
//                mActiveColor;   // non default, filter is active
        ...
        if (mShowTextAboveThumbs ) {//&& (mActivateOnDefaultValues || !selectedValuesAreDefault)
            ...
            String minText = String.valueOf(getSelectedMinValue() + " cm");
            String maxText = String.valueOf(getSelectedMaxValue() + " cm");
    ...
    public interface OnRangeSeekBarChangeListener<T> {
        ...
        void onRangeSeekBarValuesChanged(HeightRangeSeek<?> bar, T minValue, T maxValue);
    }
