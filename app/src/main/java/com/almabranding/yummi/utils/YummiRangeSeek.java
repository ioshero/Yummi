 ...
 */
public class YummiRangeSeek<T extends Number> extends ImageView {
    /**
     * Default color of a {@link YummiRangeSeek}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    ...
    public YummiRangeSeek(Context context) {
        super(context);
        init(context, null);
    }

    public YummiRangeSeek(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public YummiRangeSeek(Context context, AttributeSet attrs, int defStyle) {
...
//                mActiveColor;   // non default, filter is active
    ...
    public interface OnRangeSeekBarChangeListener<T> {
        ...
        void onRangeSeekBarValuesChanged(YummiRangeSeek<?> bar, T minValue, T maxValue);
    }
