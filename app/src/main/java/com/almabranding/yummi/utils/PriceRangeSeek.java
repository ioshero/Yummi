 ...
 */
public class PriceRangeSeek<T extends Number> extends ImageView {
    /**
     * Default color of a {@link PriceRangeSeek}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    ...
    public PriceRangeSeek(Context context) {
        super(context);
        init(context, null);
    }

    public PriceRangeSeek(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PriceRangeSeek(Context context, AttributeSet attrs, int defStyle) {
...
//                mActiveColor;   // non default, filter is active
        ...
        if (mShowTextAboveThumbs ) {//&& (mActivateOnDefaultValues || !selectedValuesAreDefault)
            ...
            String minText = String.valueOf("$"+getSelectedMinValue() + " p/h");
            String maxText = String.valueOf("$"+getSelectedMaxValue() + " p/h");
    ...
    public interface OnRangeSeekBarChangeListener<T> {
        ...
        void onRangeSeekBarValuesChanged(PriceRangeSeek<?> bar, T minValue, T maxValue);
    }
